...
const BrandTailwind = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(SVGParent.SVGParent, __spreadValues({}, rest), /* @__PURE__ */ React__default.createElement("path", { d: "M34.5,28.2c-1.4,5.6-4.9,8.4-10.5,8.4-5.21,0-7.59-2.42-9.65-4.51-1.26-1.28-2.4-2.44-4-2.84-2.8-.7-5.25,.35-7.35,3.15,1.4-5.6,4.9-8.4,10.5-8.4,5.21,0,7.59,2.42,9.65,4.51,1.26,1.28,2.4,2.44,4,2.84,2.8,.7,5.25-.35,7.35-3.15Z" }), /* @__PURE__ */ React__default.createElement("path", { d: "M45,15.6c-1.4,5.6-4.9,8.4-10.5,8.4-5.21,0-7.59-2.42-9.65-4.51-1.26-1.28-2.4-2.44-4-2.84-2.8-.7-5.25,.35-7.35,3.15,1.4-5.6,4.9-8.4,10.5-8.4,5.21,0,7.59,2.42,9.65,4.51,1.26,1.28,2.4,2.44,4,2.84,2.8,.7,5.25-.35,7.35-3.15Z" }));
};
BrandTailwind.displayName = "ioeri-icons/BrandTailwind";

exports.BrandTailwind = BrandTailwind;
